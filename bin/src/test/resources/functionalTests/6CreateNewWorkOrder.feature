...
Feature: As a user we need to create New Work Order in MPO
  ...
  Scenario: Create a New Work Order in MPO
    ...
    Then user Navigate to Page and verify the Page Title is "Welcome to Maximo MPO DEV"
    ...
    #And user click on magnifying glass icon adjacent to WBS Element text box under Asset Details
    #Then user select "C015A04151904" from the WBS Element dialog box
    And user enter "036B05" into cost center dialog box
